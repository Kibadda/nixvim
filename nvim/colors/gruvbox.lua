...
local theme = {
  ...
  TroubleText = { link = "Fg" },
  NormalFloat = { fg = colors.bright_white, bg = colors.bright_black },
  ...
  Pmenu = { fg = "#ddc7a1", bg = colors.black },
  PmenuMatch = { fg = "#ddc7a1", bg = colors.black, bold = true, underline = true },
  PmenuSel = { fg = "#928374", bg = colors.black },
  PmenuMatchSel = { fg = "#928374", bg = colors.black, bold = true, underline = true },
  PmenuSbar = { bg = "#3c3836" },
  ...
  MsgArea = {},
  FloatBorder = { fg = "#928374", bg = colors.bright_black },
  FloatTitle = { fg = "#e78a4e", bg = colors.bright_black, bold = true },
  FloatFooter = { fg = "#e78a4e", bg = colors.bright_black, bold = true },
  WinBar = { link = "Grey" },
  WinBarNC = { link = "Grey" },
  ...
  ErrorFloat = { fg = colors.bright_red, bg = colors.bright_black },
